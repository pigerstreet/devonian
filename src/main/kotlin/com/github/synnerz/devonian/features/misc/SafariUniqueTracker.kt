...
object SafariUniqueTracker : TextHudFeature(
    ...
    private val captureRegex = "^CAPTURE! You caught a ([\\w ]+) and gained a ([\\w ]+) Shard!$".toRegex()
    private val teamCaptureRegex = "^LOOT SHARE! You received a ([\\w ]+) Shard from (\\w{1,16}) catching a ([\\w ]+)!$".toRegex()
